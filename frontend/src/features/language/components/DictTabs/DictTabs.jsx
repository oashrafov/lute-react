...
import { useActiveDictTabContext } from "@book/hooks/useActiveDictTabContext";
...
export function DictTabs({
  ...
  function DictTab({ dict, tabValue }) {
    return (
  ...
  function DictTabPanel({ dict, tabValue }) {
    return (
  ...
  function VisibleTabsContainer({ children }) {
    return (
      <div
        style={{
          display: "grid",
